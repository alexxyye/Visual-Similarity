...
def plot_3D(symbol,chinese, german, english, korean,falsefont):
    ax = plt.axes(projection="3d")

    colors = ['black','blue', 'green', 'yellow', 'purple','red']
    pds = [symbol,chinese, german, english, korean,falsefont]
    names = ['symbol','chinese', 'german', 'english', 'korean','falsefont']


    # colors = ['black', 'blue', 'purple', 'red']
    # pds = [symbol, chinese, korean, falsefont]
    # names = ['symbol', 'chinese', 'korean', 'falsefont']
...
def main():
    ...
    plot_3D(symbol,chinese, german, english, korean,falsefont)
